...
console.log(MenuElemaniOlustur("döner", 48, "yiyecek"));
...
console.log(
  DegerlendirmeEkle(degerlendirmeler, "Ömer", 2, "Yemekler çok güzel.")
);
/*  Görev 6: 
...
function SonDegerlendirmeyiAl(degerlendirmeler) {
  const degerlendirme = degerlendirmeler[degerlendirmeler.length - 1];
  return `${degerlendirme.isim} isimli kişi ${degerlendirme.puan} puan verdi ve şunları yazdı: ${degerlendirme.geribildirim}`;
}
